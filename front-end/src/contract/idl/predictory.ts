...
export type Predictory = {
  ...
  instructions: [
    ...
    {
      name: "burnTrust";
      discriminator: [170, 125, 109, 46, 43, 115, 252, 158];
      accounts: [
        {
          name: "sender";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [154, 176, 240, 33, 158, 39, 157, 218];
      accounts: [
        {
          name: "sender";
          writable: true;
  ...
  accounts: [
    {
      name: "appellation";
      discriminator: [10, 14, 128, 59, 61, 171, 204, 61];
    },
    {
      name: "event";
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "disagreeCount";
            docs: ["Participant appellation count"];
            type: "u64";
          },
          {
          ...
          {
            name: "disagreeVolume";
            docs: ["Participant deposit volume"];
            type: "u64";
          },
        ];
      };
      ...
      type: {
        ...
        fields: [
          ...
          },
          {
            ...
            docs: ["Event participation count"];
            type: "u64";
          },
          {
            name: "totalAmount";
            docs: ["Total amount of tokens in all pools"];
            type: "u64";
          },
          {
            name: "totalTrust";
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "appealed";
            docs: ["Whether the user has appealed"];
            type: "bool";
          },
        ];
      };
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "lockedStake";
            docs: ["User locked stake (only for view)"];
            type: "u64";
          },
          {
            name: "trustLvl";
            docs: ["User trust level"];
            type: "u64";
          },
          {
            name: "name";
